            ...
            try
            {
                textbox_TrackLengthCustom.TextChanged += (sender, e) =>
                {
                    try
                    {
                        ...
                        if (trackLength >= 20)
                        {
                            vSettings.Set("TrackLengthCustom", senderElement.Text);
                ...
                combobox_TrackPercentageScrobble.SelectionChanged += (sender, e) =>
                {
                    try
                    {
                        ...
                        {
                            vSettings.Set("TrackPercentageScrobble", "25");
                        }
                        else if (senderElement.SelectedIndex == 1)
                        {
                            vSettings.Set("TrackPercentageScrobble", "50");
                        }
                        else if (senderElement.SelectedIndex == 2)
                        {
                            vSettings.Set("TrackPercentageScrobble", "75");
                        }
                        else if (senderElement.SelectedIndex == 3)
                        {
                            vSettings.Set("TrackPercentageScrobble", "90");
                        }
                    }
                    catch { }
                };
                ...
                checkbox_TrackShowOverlay.Click += (sender, e) =>
                {
                    try
                    {
                        ...
                        vSettings.Set("TrackShowOverlay", senderElement.IsChecked);
                    }
                    catch { }
                };
                ...
                checkbox_VolumeShowOverlay.Click += (sender, e) =>
                {
                    ...
                    {
                        CheckBox senderElement = sender as CheckBox;
                        vSettings.Set("VolumeShowOverlay", senderElement.IsChecked);
                    }
                    catch { }
                };
                ...
                checkbox_LastFMUpdateNowPlaying.Click += (sender, e) =>
                {
                    ...
                    {
                        CheckBox senderElement = sender as CheckBox;
                        vSettings.Set("LastFMUpdateNowPlaying", senderElement.IsChecked);
                    }
                    catch { }
                };
            }
